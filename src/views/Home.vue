<template>
    <div class="home">
        ...
        <div class="solution">
            <div class="title">行业解决方案</div>
            <div class="items">
                <div class="item" :style="'background-image: url('+require('../assets/images/solution1.png')+')'">
                    <div class="line1">直播平台解决方案</div>
                    <div class="line2">拍摄直播、PPT直播、桌面共享直播，传播简单快捷、时效高、受众广，助理商家高效流量变现</div>
                </div>
                <div class="item" :style="'background-image: url('+require('../assets/images/solution2.png')+')'">
                    <div class="line1">教育平台解决方案</div>
                    <div class="line2">拍摄直播、PPT直播、桌面共享直播，传播简单快捷、时效高、受众广，助理商家高效流量变现</div>
                </div>
                <div class="item" :style="'background-image: url('+require('../assets/images/solution3.png')+')'">
        ...
        <div class="news">
            ...
            <div class="items">
                <div :class="'item active-news'+index"
                     v-for="(item,index) in 4" :key="index">
                    <div class="left">
                        <div class="img" :style="'background-image: url('+require('../assets/images/news0.png')+')'"></div>
                    </div>
                    <div class="right">
